...
def getPerPageInfo(url,number):
    ...
    for post in postList:
        ...
        infoList = [postTitle, postSalary,postadd, postEDU, postExperience,postName,postxingzhi,postfuli1]
        print(number2,postTitle, postSalary, postEDU, postExperience,postName,postxingzhi)
